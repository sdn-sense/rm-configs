...
--from-file=agent-hostcert-1=certs/fiona.its.hawaii.edu/hostcert.pem  \
--from-file=agent-hostcert-2=certs/dtn-hurp.ifa.hawaii.edu/hostcert.pem \
--from-file=agent-hostcert-3=certs/k8s-dtn-01.uog.edu/hostcert.pem \
-n hawaii-opennsa
